 ...
 * @LastEditors: mqp
 * @LastEditTime: 2020-07-28 18:31:56
 */
// initial state
const state = {
  user: {
  ...
  exam: {
    ...
    question: {
      ...
      editUrlEnum: [{ key: 1, value: '/exam-manage/question/edit/singleChoice', name: '单选题' },
      { key: 2, value: '/exam-manage/question/edit/multipleChoice', name: '多选题' },
      { key: 3, value: '/exam-manage/question/edit/trueFalse', name: '判断题' },
      { key: 4, value: '/exam-manage/question/edit/gapFilling', name: '填空题' },
      { key: 5, value: '/exam-manage/question/edit/shortAnswer', name: '简答题' }],
      answer: {
        ...
        doCompletedTag: [{ key: false, value: 'info' }, { key: true, value: 'success' }, { key: null, value: 'danger' }]
      }
    }
  }
}
